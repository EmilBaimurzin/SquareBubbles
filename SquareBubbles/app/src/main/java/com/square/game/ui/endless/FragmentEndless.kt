...
import com.square.game.databinding.FragmentEndlessBinding
...
class FragmentEndless : ViewBindingFragment<FragmentEndlessBinding>(FragmentEndlessBinding::inflate) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.buttonSettings.setOnClickListener {
            ...
            findNavController().navigate(FragmentEndlessDirections.actionFragmentEndlessToDialogOptions(Game.ENDLESS, true))
        }
    ...
    private fun end() {
        ...
        findNavController().navigate(
            FragmentEndlessDirections.actionFragmentEndlessToDialogEnd(
